<template>
  <div>
    ...
    <v-card>
        ...
        <v-form @submit.prevent="createDisease" lazy-validation ref="form" enctype="multipart/form-data" class="mt-5">
    ...
    methods: {
            ...
            createDisease(e) {
                if(this.$refs.form.validate()) {
                    ...
                    this.axios.post('http://localhost:8000/api/crop-disease/create', data, config)
                        .then(function (res) {
